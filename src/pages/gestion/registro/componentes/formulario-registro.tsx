...
import {
  TerminosCondiciones,
  PoliticaPrivacidad,
} from "@/pages/landing/componentes/modales";
...
export default function RegistroForm({
  ...
  const handleSubmit = () => {
    ...
    if (!result.success) {
      // Convertir los errores de Zod a un objeto de errores
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="grid gap-1.5 sm:gap-2">
                    ...
                    <p className="text-[10px] sm:text-xs text-gray-400">
                      Necesaria para verificar la identidad del ganador y
                      Facturación
                    </p>
                  </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="grid gap-1.5 sm:gap-2">
                    ...
                    <Input
                      ...
                      required
                      className={cn(
                        "bg-slate-700 border-slate-600 text-white placeholder:text-gray-400 focus:border-amber-400 focus:ring-amber-400 text-sm h-9 sm:h-10",
                        errors.password &&
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-start space-x-2 sm:space-x-3">
                      ...
                      <div className="flex-1">
                        <Label
                          htmlFor="terminos"
                          className="text-xs sm:text-sm leading-relaxed cursor-pointer text-gray-300"
                        >
                          Acepto los{" "}
                          <TerminosCondiciones
                            trigger={
                    ...
                    <div className="flex items-start space-x-2 sm:space-x-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setAceptaPrivacidad(checked as boolean)
                        }
                        className="mt-0.5 border-2 border-amber-400 data-[state=checked]:bg-amber-600 data-[state=checked]:border-amber-600"
                      />
                      <div className="flex-1">
                    ...
                    <div className="flex items-start space-x-2 sm:space-x-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setRecibirPromociones(checked as boolean)
                        }
                        className="mt-0.5 border-2 border-amber-400 data-[state=checked]:bg-amber-600 data-[state=checked]:border-amber-600"
                      />
                      <div className="flex-1">
                        <Label
                          ...
                          className="text-xs sm:text-sm leading-relaxed cursor-pointer text-gray-300"
                        >
                          Deseo recibir información sobre nuevos sorteos y
                          promociones
                        </Label>
                      </div>
                    </div>
                  ...
                  <div className="bg-amber-900/20 border border-amber-400/30 rounded-lg p-2.5 sm:p-3 mt-3 sm:mt-4">
                    <div className="flex items-start space-x-2">
                      ...
                      <div className="text-[10px] sm:text-xs text-amber-200">
                        ...
                        <p>
                          Todos los datos son verificados antes de la entrega
                          del premio. Asegúrate de que la información sea
